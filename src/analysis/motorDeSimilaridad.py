...
df_contrato = pd.read_csv("data/contratosParaAnalizar/clausulas_contrato.csv")
...
df_final.to_csv("data/prediccionAbusividad.csv", index=False, encoding="utf-8")
print("\n✅ Análisis completo guardado en 'data/prediccionAbusividad.csv'")